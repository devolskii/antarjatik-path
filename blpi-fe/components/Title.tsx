...
export default function Title({
  ...
  return (
    <div className="flex items-center gap-x-3 sticky top-0 bg-white xl:relative">
      ...
      >
        <h1
          className={`transform transition-all duration-300 ${isSticky ? "scale-90" : "scale-100"} ${isSticky ? "text-xl" : "text-4xl"} font-bold mt-4 mb-3 xl:transform-none xl:transition-none`}
        >
          {title}
        </h1>
      </div>
